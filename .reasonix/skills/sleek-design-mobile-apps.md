...
description: AI-powered mobile app design via Sleek API — create projects, describe UI in natural language, render screens
runAs: inline
---

# Designing with Sleek

**Source:** Adapted from [sleekdotdesign/agent-skills](https://github.com/sleekdotdesign/agent-skills) — open agent skills ecosystem
